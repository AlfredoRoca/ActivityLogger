...
RSpec.describe TeamsController, :type => :controller do
  ...
  let(:invalid_attributes) {
    FactoryGirl.attributes_for :invalid_team
  }
  ...
  context "when logged as admin" do
    ...
    describe "GET new" do
      it "return a new team" do
        get :new, {}, valid_session
        expect(assigns(:team)).to be_a_new(Team)
      end
    end

    describe "returns the team to be edited" do
  ...
  context "when logged as user" do
    ...
    describe "PUT update" do
      describe "with valid params" do
        ...
        it "can not update the requested team" do
          team = Team.create! valid_attributes
          put :update, {:id => team.to_param, :team => new_attributes}, valid_session
          team.reload
          expect(assigns(:team)).not_to eq(team)
        end
